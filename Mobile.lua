...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('ThuanNzo Hub PREMIUM') then
        makefolder('ThuanNzo Hub PREMIUM')
    end
    if not _G.Dis and not isfile('ThuanNzo Hub PREMIUM/'..Name..'.json') then
        writefile('ThuanNzo Hub PREMIUM/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('ThuanNzo Hub PREMIUM') and isfile('ThuanNzo Hub PREMIUM/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('ThuanNzo Hub PREMIUM/'..Name..'.json'))
...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		Logo.Image = "rbxassetid://16196383608"..tostring(logo)
...
game.StarterGui:SetCore("SendNotification", {
	Title = "ThuanNzo Notification", 
	Text = "Có Tiền Bạn sẽ có tất cả",
