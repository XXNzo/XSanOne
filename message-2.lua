...
ImageButton.Image = "http://www.roblox.com/asset/?id=10241251176" --ใส่ลิ้งรูปปุ่มซ่อน/โชว์ui
ImageButton.MouseButton1Down:connect(function()
game.CoreGui:FindFirstChild("OKuUi").Enabled = not game.CoreGui:FindFirstChild("OKuUi").Enabled
end)
--9849581539
...
--10240321390
--10230947140
do local GUI = game.CoreGui:FindFirstChild("OKuUi");if GUI then GUI:Destroy();end;if _G.Color == nil then
    _G.Color = Color3.fromRGB(153,102,255)--เปลียนสี
	_G.ColorBackground = Color3.fromRGB(0,0,0)
   	_G.ColorText = Color3.fromRGB(255,255,255)--เปลียนสี
...
local Library = Update:Window("OKUMON","6023426909",Enum.KeyCode.RightControl);
Main = Library:Tab("Main","6023426909")
M = Library:Tab("Misc Farm")
Ss = Library:Tab("Stats")
St = Library:Tab("Setting")
...
Main:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
    ...
    spawn(function()
        ...
        M:Seperator("Dought Boss")
    
        local MobKilled = M:Label("Killed")
    ...
    M:Toggle("Auto Dought Boss",_G.AutoDoughtBoss,function(value)
...
spawn(function()
   ...
   St:Toggle("Magnet",true,function(vu)
    _G.MagnetActive = vu
    end)
	...
	for i, v in pairs(game.workspace.Enemies:GetChildren()) do
		...
		if x.Name == Mon then
			if v.Name == Mon then
				...
				v.HumanoidRootPart.CanCollide = false
				v.HumanoidRootPart.Size = Vector3.new(800,800,800)
				sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
			end
		end
		end
...
spawn(function()
    ...
    St:Toggle("Fast Attack ",true,function(value)
        ...
        St:Toggle("Ultimate Fast Attack",nil,function(value)
...
spawn(function()
        ...
        if _G.FastAttack then
            if typeof(y) == "table" then
                pcall(function()
                    ...
                    y.activeController.hitboxMagnitude = 150000
                    y.activeController.active = false
                    y.activeController.timeToNextBlock = 0
                    y.activeController.focusStart = 7543400000
                    y.activeController.increment = 10000
    ...
    St:Toggle("Remove Attack",false,function(value)
...
spawn(function()
    ...
    St:Toggle("Delete Attack FIx",nil,function(d)
    _G.DeleteAttackFx = d
