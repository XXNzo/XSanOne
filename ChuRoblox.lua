...
SOMEXHUBMODILE.Name = "SOMEXHUBMODILE"
        ...
        MODILEMAGE.Image = "rbxassetid://14259751426"
...
local LogoHub = Instance.new("ImageLabel")
	...
	LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(14259751426)
...
local LogoToggle = Instance.new("ImageLabel")
	...
	LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(14259751426)
...
local Library = Update:Window("Chú Roblox","14259751426",Enum.KeyCode.RightControl);
...
Main:Seperator("Welcome To Chú Roblox Channel")

Main:Button("Copy Link Discord",function()
    setclipboard("https://discord.gg/c2qWH55Zrv")
end)
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                                    ...
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            repeat task.wait()
                                                ...
                                                topos(v.HumanoidRootPart.CFrame * CFrame.new(2,15,3))
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild(Mon) then
                                ...
                                if (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1 then
                                    if PosMon ~= nil then
                                        topos(PosMon * CFrame.new(2,10,15))
                                    else
                                        if OldPos ~= nil then
...
Main:Toggle("Black Screen",_G.BScreen,function(vu)
    _G.BScreen = vu
    if _G.BScreen then
